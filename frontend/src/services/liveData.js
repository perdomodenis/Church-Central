...
const LIVE_MEMBERS = [
  ...
  },
  {
    ...
    status: 'online',
    recentActivity: 'Sent message in Disciples Training Ministry (DTM) group'
  },
  {
    uid: 'member_002',
  ...
  },
  {
    ...
    interests: ['Disciples Training Ministry (DTM)', 'Theology'],
    profilePhoto: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=60',
    joined: '2014-02-14',
  ...
  },
  {
    ...
    interests: ['Organization', 'Media Ministry'],
    profilePhoto: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=60',
    joined: '2013-06-01',
  ...
  },
  {
    ...
    interests: ['Disciples Training Ministry (DTM)', 'Community'],
    profilePhoto: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=400&q=60',
    joined: '2019-03-17',
  ...
  },
  {
    ...
    interests: ['Media Ministry', 'Streaming'],
    profilePhoto: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=60',
    joined: '2020-02-09',
  ...
  },
  {
    ...
    interests: ['Media Ministry', 'Social Media'],
    profilePhoto: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=400&q=60',
    joined: '2021-05-12',
...
const LIVE_FEED_POSTS = [
  ...
  },
  {
    ...
    content: 'Disciples Training Ministry (DTM) Discussion: How do we balance faith and works? Join us Wednesday 7 PM to explore Romans 3:28 and James 2:26. Deep dive!',
    scope: 'News',
    category: 'Discussion',
    image: 'https://images.unsplash.com/photo-1507842217343-583f20270319?auto=format&fit=crop&w=800&q=80',
    likes: 28,
...
const LIVE_CHURCH_EVENTS = [
  ...
  },
  {
    ...
    time: '07:00 PM',
    endTime: '08:30 PM',
    location: 'Glory Court - Worship Center',
  ...
  },
  {
    ...
    time: '10:00 AM',
    endTime: '11:30 AM',
    location: 'Glory Court - Sanctuary',
  ...
  {
    id: 'event_wed_1',
    title: '📖 Disciples Training Ministry (DTM) - Psalms Series',
    date: day3Str,
    time: '07:00 PM',
    endTime: '08:30 PM',
  ...
  try {
    ...
    await Promise.all(LIVE_MEMBERS.map(async (member) => {
      await upsertUserProfile({
        ...
        first: member.first,
        last: member.last,
        court: member.campus || 'Glory Court',
